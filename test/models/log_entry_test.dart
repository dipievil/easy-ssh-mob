  ...
  group('LogEntry', () {
    ...
    group('serialization', () {
      test('should convert to and from JSON correctly', () {
        ...
        expect(restoredEntry.workingDirectory, equals(originalEntry.workingDirectory));
    ...
    group('formatting methods', () {
      ...
      test('should create stdout and stderr previews', () {
        final entry = LogEntry(
          ...
          type: CommandType.fileView,
          workingDirectory: '/home',
          stdout: 'This is a very long line that should be truncated in preview because it exceeds the maximum length allowed for preview display',
          stderr: 'Warning: file is large and may take time to process completely',
    ...
    group('CSV formatting', () {
      ...
      test('should escape CSV fields with commas', () {
        ...
        final csvRow = entry.toCsvRow();
        expect(csvRow, contains('"echo "hello, world""')); // command should be escaped
