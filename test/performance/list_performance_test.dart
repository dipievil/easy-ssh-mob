...
void main() {
  group('Performance Tests', () {
    ...
    testWidgets('should scroll smoothly through large lists', (WidgetTester tester) async {
      final largeFileList = List.generate(500, (i) => 
        SshFile(
          name: 'item_$i.txt',
    ...
    testWidgets('should use cached icons efficiently', (WidgetTester tester) async {
      // Criar arquivos com tipos variados para testar cache de ícones
      final mixedFileList = [
        ...List.generate(100, (i) => SshFile(
    ...
    testWidgets('should handle frequent updates efficiently', (WidgetTester tester) async {
      final initialList = List.generate(200, (i) => 
        SshFile(
          name: 'file_$i.txt',
          fullPath: '/path/file_$i.txt',
          type: FileType.regular,
    ...
    testWidgets('should efficiently handle different file sizes and dates', (WidgetTester tester) async {
      final complexFileList = List.generate(300, (i) {
        final size = i * 1024; // Tamanhos variados
        final date = DateTime.now().subtract(Duration(days: i ~/ 10)); // Datas variadas
    ...
    testWidgets('should efficiently reuse widgets with ValueKey', (WidgetTester tester) async {
      var fileList = List.generate(100, (i) => 
        SshFile(
          name: 'file_$i.txt',
          fullPath: '/path/file_$i.txt',
          type: FileType.regular,
    ...
    testWidgets('should handle memory efficiently with large lists', (WidgetTester tester) async {
      ...
      final veryLargeList = List.generate(2000, (i) => 
        SshFile(
    ...
    test('file size formatting performance', () {
      ...
      for (int i = 0; i < 10000; i++) {
        ...
        final _ = '${formattedSize.toStringAsFixed(suffixIndex == 0 ? 0 : 1)} ${suffixes[suffixIndex]}';
      }
