...
void main() {
  group('LoginScreen Widget Tests', () {
    ...
    testWidgets('should validate required fields on connect', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('should validate port field correctly', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('should show/hide password correctly', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
    ...
    testWidgets('should show error message when connection fails', (WidgetTester tester) async {
    ...
    testWidgets('should handle remember credentials checkbox', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
      await tester.pumpAndSettle();
