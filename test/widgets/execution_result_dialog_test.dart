...
void main() {
  group('ExecutionResultDialog', () {
    ...
    testWidgets('should display error dialog with tabs', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('should display empty result dialog', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
    ...
    testWidgets('should handle long file names with ellipsis', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
              builder: (context) => ElevatedButton(
                onPressed: () => showDialog(
                  ...
                  builder: (context) => ExecutionResultDialog(
                    result: successResult,
                    fileName: 'very_long_file_name_that_should_be_truncated_with_ellipsis.sh',
                  ),
                ),
                child: const Text('Show Dialog'),
              ),
      ...
      expect(find.textContaining('Execução: very_long_file_name'), findsOneWidget);
    });
  });
}